 ...
 * Credibility weights: CRM=1.0, ADMS/Attendance=0.9, Third-party=0.7 (defaults)
 *
 * @author isharryfung
 * @since 2026-05-13
 */
...
public class SourceCredibilityScorerMockTest {
    ...
    /**
     * Test: Third-party Source - Google Forms (0.7x multiplier)
     */
    @Test
    @DisplayName("Third-Party Source (0.7x): Google Forms")
    ...
    /**
     * Test: Third-Party Ticketing (0.7x multiplier)
     */
    @Test
    @DisplayName("Third-Party Source (0.7x): Third-Party Ticketing")
    ...
    /**
     * Test: Unknown Source (0.7x multiplier - defaults to THIRD_PARTY)
     */
    @Test
     ...
     *
     * 90% base match × 0.7x (THIRD_PARTY) = 63%
     * Result: Below TIER_2_THRESHOLD (0.70) → routes to manual review
     */
    @Test
    @DisplayName("Real-World: 90% Base × 0.7x (Google Forms) = 63%")
    public void testRealWorldGoogleFormsScenario() {
        ...
        assertEquals(SourceSystemConstant.CREDIBILITY_THIRD_PARTY, multiplier, 0.001);
        assertTrue(finalScore < 0.95, "Should NOT be auto-mergeable at tier 1 level");
    ...
    public void testRealWorldAdmsScenario() {
        ...
        assertEquals(SourceSystemConstant.CREDIBILITY_ADMS, multiplier, 0.001);
        assertTrue(finalScore > 0.70, "Should exceed TIER_2_THRESHOLD");
     ...
     * 90% base × THIRD_PARTY(0.7) = 63% — below TIER_2_THRESHOLD
     */
    @Test
    ...
    public void testSourceCredibilityPreventsFalseMerges() {
        ...
        assertTrue(admsFinalScore > 0.70, "ADMS 90% should exceed TIER_2_THRESHOLD");
        assertFalse(thirdPartyFinalScore >= 0.95, "Google Forms should NOT reach 95%");
