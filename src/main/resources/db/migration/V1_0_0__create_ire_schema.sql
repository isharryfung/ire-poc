...
-- Created: 2026-05-13
-- 
-- H2-COMPATIBLE SQL: Uses GENERATED BY DEFAULT AS IDENTITY for auto-increment, standard UNIQUE constraints
...
-- ============================================================================
INSERT INTO source_credibility (SOURCE_SYSTEM, CREDIBILITY_SCORE, DESCRIPTION) VALUES ('CRM', 1.0, 'Master data system - highest credibility (100% trusted)');
INSERT INTO source_credibility (SOURCE_SYSTEM, CREDIBILITY_SCORE, DESCRIPTION) VALUES ('ADMS', 0.9, 'Admissions system - high credibility (90% trusted)');
INSERT INTO source_credibility (SOURCE_SYSTEM, CREDIBILITY_SCORE, DESCRIPTION) VALUES ('ATTENDANCE', 0.9, 'Attendance system - high credibility (90% trusted)');
INSERT INTO source_credibility (SOURCE_SYSTEM, CREDIBILITY_SCORE, DESCRIPTION) VALUES ('EVENT_SYSTEM', 0.9, 'Event management system - high credibility (90% trusted)');
INSERT INTO source_credibility (SOURCE_SYSTEM, CREDIBILITY_SCORE, DESCRIPTION) VALUES ('IAM', 1.0, 'Identity & Access Management - highest credibility (100% trusted)');
INSERT INTO source_credibility (SOURCE_SYSTEM, CREDIBILITY_SCORE, DESCRIPTION) VALUES ('THIRD_PARTY', 0.8, 'Third-party forms and sources - medium credibility (80% trusted)');
INSERT INTO source_credibility (SOURCE_SYSTEM, CREDIBILITY_SCORE, DESCRIPTION) VALUES ('GOOGLE_FORMS', 0.8, 'Google Forms submissions - medium credibility (80% trusted)');

-- ============================================================================
-- SEED DATA: Confidence Thresholds
-- Threshold values for Tier-2 auto-merge and manual review routing
-- ============================================================================
INSERT INTO confidence_thresholds (THRESHOLD_ID, THRESHOLD_TYPE, THRESHOLD_VALUE, DESCRIPTION) VALUES ('TIER2_THRESHOLD', 'TIER2_MINIMUM', 0.70, 'Minimum confidence for Tier-2 matching (70%)');
INSERT INTO confidence_thresholds (THRESHOLD_ID, THRESHOLD_TYPE, THRESHOLD_VALUE, DESCRIPTION) VALUES ('AUTO_MERGE_THRESHOLD', 'AUTO_MERGE', 0.85, 'Minimum confidence for automatic merge (85%)');
INSERT INTO confidence_thresholds (THRESHOLD_ID, THRESHOLD_TYPE, THRESHOLD_VALUE, DESCRIPTION) VALUES ('MANUAL_REVIEW_MIN', 'MANUAL_REVIEW', 0.50, 'Minimum confidence for manual review (50%)');
INSERT INTO confidence_thresholds (THRESHOLD_ID, THRESHOLD_TYPE, THRESHOLD_VALUE, DESCRIPTION) VALUES ('MANUAL_REVIEW_MAX', 'MANUAL_REVIEW_UPPER', 0.85, 'Maximum confidence for manual review (85%)');

-- ============================================================================
-- SEED DATA: Sample Identity
-- Test identity for verification
-- ============================================================================
INSERT INTO identities (GOLDEN_ID, HKID, STAFF_ID, EMAIL, FIRST_NAME, LAST_NAME, STATUS, CREATED_BY) VALUES ('GID-001', 'A123456(7)', 'STF000001', 'john.doe@ust.hk', 'John', 'Doe', 'ACTIVE', 'SYSTEM');

-- ============================================================================
-- SEED DATA: Sample Identity Links
-- ============================================================================
INSERT INTO identity_links (GOLDEN_ID, SOURCE_SYSTEM, SOURCE_ID, MATCH_TIER, STATUS, CREATED_DATE) VALUES ('GID-001', 'ADMS', 'ADMS-20150001', 'TIER_1', 'ACTIVE', CURRENT_TIMESTAMP);
INSERT INTO identity_links (GOLDEN_ID, SOURCE_SYSTEM, SOURCE_ID, MATCH_TIER, STATUS, CREATED_DATE) VALUES ('GID-001', 'CRM', 'CRM-00001', 'TIER_1', 'ACTIVE', CURRENT_TIMESTAMP);
